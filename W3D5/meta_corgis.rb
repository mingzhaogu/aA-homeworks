...
class MetaCorgiSnacks
  ...
  #
  #     info = @snack_box.send(info_method.to_s, @box_id)
  #     tastiness = @snack_box.send(tastiness_method.to_s, @box_id)
  #
  ...
  def self.define_snack(name)
    define_method(name) do
      info_method = "get_#{name}_info".to_s
      tastiness_method = "get_#{name}_tastiness".to_s
